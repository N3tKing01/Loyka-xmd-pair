...
externalAdReply: {
title: "𝕁𝕆𝕊ℍ𝕂𝕀ℕ𝔾 𝕋𝔼ℂℍ",
thumbnailUrl: "https://i.postimg.cc/3Jztb3Ft/boykamxdwepagwelo.jpgg",
...
{quoted:code })
                            ...
                            let desc = `*ᴅᴏɴ'ᴛ sʜᴀʀᴇ ᴡɪᴛʜ ᴀɴʏᴏɴᴇ ᴛʜɪs ᴄᴏᴅᴇ ᴜsᴇ ғᴏʀ ᴅᴇᴘʟᴏʏ ʙᴏʏᴋᴀ-ᴍxᴅ*\n\n ◦ *Gɪᴛʜᴜʙ:* https://github.com/JoshKingofc/BOYKA-MXD`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
title: "𝕁𝕆𝕊ℍ𝕂𝕀ℕ𝔾 𝕋𝔼ℂℍ",
thumbnailUrl: "https://i.postimg.cc/3Jztb3Ft/boykamxdwepagwelo.jpg",
sourceUrl: "https://whatsapp.com/channel/0029VaraMtfFcowAKRdDdp1T",
mediaType: 2,
renderLargerThumbnail: true,
